...
CREATE TABLE IF NOT EXISTS bar_entity_beer_entity
(
    bar_id BIGINT NOT NULL,
    beer_id BIGINT NOT NULL, 
    CONSTRAINT inventory_bar foreign key (bar_id) references bar_entity(bar_id), 
    CONSTRAINT inventory_beer foreign key (beer_id) references beer_entity(beer_id)
) CHARACTER SET=utf8 COLLATE utf8_general_ci;
...
INSERT INTO bar_entity_beer_entity(`bar_id`, `beer_id`) VALUES
